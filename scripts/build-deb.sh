...
checkinstall -D -y \
	...
	--provides=pix \
	--requires="kquickimageeditor,libc6,libexiv2-27,libgcc-s1,libkf5coreaddons5,libkf5i18n5,libqt5core5a,libqt5gui5,libqt5qml5,libqt5widgets5,libstdc++6,mauikit-git \(\>= 3.0.0+git\),mauikit-filebrowsing-git \(\>= 3.0.0+git\),mauikit-imagetools-git \(\>= 3.0.0+git\),qml-module-qt-labs-platform,qml-module-qtlocation,qml-module-qtpositioning" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
